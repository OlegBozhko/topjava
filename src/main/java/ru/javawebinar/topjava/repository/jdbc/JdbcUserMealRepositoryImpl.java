...
public class JdbcUserMealRepositoryImpl implements UserMealRepository {
    ...
    public List<UserMeal> getBetween(LocalDateTime startDate, LocalDateTime endDate, int userId) {
        return jdbcTemplate.query("SELECT * FROM meals WHERE user_id=? AND date_time BETWEEN '" + Timestamp.valueOf(startDate) + "' AND '"
                + Timestamp.valueOf(endDate) + "' ORDER BY date_time DESC",
                ROW_MAPPER, userId);
    }
}
