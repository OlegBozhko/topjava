...
//for testing
    public Map<Integer, UserMeal> mealMap = new ConcurrentHashMap<>();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<UserMealWithExceed> list =
                UserMealsUtil.getFilteredMealsWithExceeded(mealList, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);
        request.setAttribute("list", list);
        request.getRequestDispatcher("/mealServlet.jsp").forward(request, response);
    }
}
