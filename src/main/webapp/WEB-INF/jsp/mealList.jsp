    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" id="detailsForm" action="/meals">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type = "datetime-local" class="time-picker" id="dateTime" name="dateTime" placeholder="Date">
                        </div>
                    </div>
